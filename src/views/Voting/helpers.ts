...
import { ADMIN_ADDRESS, PANMARCO_SPACE, SNAPSHOT_VERSION } from './config'
...
export const generateMetaData = () => {
  return {
    plugins: {},
    network: 56,
    strategies: [{ name: 'cake', params: { symbol: 'MARCO', address: getCakeAddress(), decimals: 18 } }],
  }
}

      ...
      if(account)
      {
            ...
            setMystate(<StyledCard isActive={!false}>
              <FarmCardInnerContainer>
                ...
                <br/>
                <img alt="nft" src={"https://red-wonderful-stork-305.mypinata.cloud/ipfs/Qmc3ED4CJoqJiWPS1Nmt8r6JR8vCQWLHGRifZkHDrCKNTD/nft.png".concat(tid).concat(".png")} onError={err=>{err.currentTarget.src="/logo.png"}}/>
                <br/>
                <Flex justifyContent="space-between">
                ...
                <Button display={res.owner!==account&&isOnSale?"block":"none"}  onClick={
                  onPresentContributeModal
                }>Buy</Button>
                  <Button display={res.owner===account||!isOnSale?"block":"none"} onClick={async ()=>{
                    try {

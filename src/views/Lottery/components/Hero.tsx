...
const StyledBuyTicketButton = styled(BuyTicketsButton)<{ disabled: boolean }>`
  background: ${({ theme, disabled }) =>
    disabled ? theme.colors.disabled : 'linear-gradient(180deg, #0048D9 0%, #452a7a 100%)'};
  width: 200px;
...
const Hero = () => {
  ...
  const getHeroHeading = () => {
    if (status === LotteryStatus.OPEN) {
      return (
        <>
          ...
          <Heading mb="32px" scale="lg" color="#0048D9">
            {t('in prizes!')}
          </Heading>
        </>
      )
    ...
    return (
      <Heading mb="24px" scale="xl" color="#0048D9">
  ...
  return (
    <Flex flexDirection="column" alignItems="center" justifyContent="center">
      ...
      <Heading mb="8px" scale="md" color="#0048D9">

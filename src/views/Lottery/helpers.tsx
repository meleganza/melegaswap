...
export const processLotteryResponse = (
  ...
  const priceTicketInDexToken = new BigNumber(priceTicketInDexTokenAsString)
  const amountCollectedInDexToken = new BigNumber(amountCollectedInDexTokenAsString)

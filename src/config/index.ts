...
// MARCO_PER_BLOCK details
// 40 MARCO is minted per block
// 20 MARCO per block is sent to Burn pool (A farm just for burning cake)
// 10 MARCO per block goes to MARCO syrup pool
...
export const MARCO_PER_BLOCK = new BigNumber(0.001)
